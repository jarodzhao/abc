	...
	<div class="container" style="border: 0px dotted #CCC">
		<form method="post" action="/save">
			<div class="form-group">
				<label for="name">名称：</label> <input id="name" type="text" name="name" style="font-size: 12px; width: 200px;" />
			</div>
			<div class="form-group">
				<label for="author"> 作者：</label> <input id="author" type="text" name="author" style="font-size: 12px; width: 200px;" />
			</div>
			<div class="form-group">
				<label for="type"> 类别：</label> <input id="type" type="text" name="type" style="font-size: 12px; width: 200px;" />
			</div>
			<div class="form-group">
				<label for="description"> 描述：</label>
				<textarea id="description" style="vertical-align: top; width: 300px; height: 200px;" name="description"></textarea>
			</div>
			<div class="form-group">
